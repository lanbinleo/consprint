...
func (a *App) Router() *gin.Engine {
	...
	protected.GET("/practice/attempts", a.attemptList)
	...
	staff.GET("/admin/stimuli", a.listStimuli)
	staff.POST("/admin/stimuli", a.createStimulus)
	staff.PATCH("/admin/stimuli/:id", a.updateStimulus)
	staff.POST("/admin/question-images", a.uploadQuestionImage)
